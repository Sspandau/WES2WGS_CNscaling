#!/bin/bash
#SBATCH --job-name=wes_wgs_pooled
...
# Usage:
#   sbatch compare_wes_wgs_overlap_pooled_slurm.sh MANIFEST OUTDIR [MAX_FRAC] [MIN_CN_LIKE] [AGGREGATE] [MASK_REGIONS] [WES_COLUMN] [WGS_COLUMN]
...
python3 /home/sspandau/WES2WGS_CNscaling/scripts/compare_wes_wgs_overlap_bayes_pooled.py "${ARGS[@]}"