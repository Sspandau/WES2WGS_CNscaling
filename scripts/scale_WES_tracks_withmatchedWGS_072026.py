...
def main():
    ...
    mappability = df_pon['mappability'].values if 'mappability' in df_pon.columns else None
    ...
    for bam_path in tumor_bams:
        ...
        depth_scaled = apply_pon_multivariate_loess_correction(raw_wes_depth, pon_median, offtarget_gc, dist_to_target, mappability)
