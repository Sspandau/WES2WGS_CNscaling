...
def main():
    ...
    parser.add_argument("--min-frac", type=float, default=0.0005, help="Min fraction of bins called amplified per track")
    parser.add_argument("--max-frac", type=float, default=0.01, help="Max fraction of bins called amplified per track")
